...
function showFirstAndLast(arr){
    ...
    arr.map(function(each){
        arr2.push(each[0]+each[each.length-1]);
    })
    return arr2;
}
...
array of objects, a key, and some value to search 
...
Write a function called removeVowels which accepts a string
 and returns a new string with all of the vowels (both 
    uppercased and lowercased) removed. Every character in 
...
function removeVowels(str) {
    return [...str.toLowerCase()].filter(function(char){
